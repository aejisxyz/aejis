#!/usr/bin/env python3
"""Direct XLSX processing without Docker"""
...
def process_xlsx_direct(file_path: str) -> dict:
    """Process XLSX file directly without Docker"""
    try:
        # Read the file
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) > 1:
        result = process_xlsx_direct(sys.argv[1])
